...
Self-aware
        ...
        <section className="contact-info">
          ...
          <div className="explicit-links">
            <h3>
              <span className="connect">Email me at </span>
              <span className="link">vernonmensah@gmail.com.</span>
            </h3>
            <h3>
              <span className="connect">Connect with me on </span>
              <span className="link"> linkedin.com/in/vernonmensah.</span>
            </h3>
            <h3>
              <span className="connect">Code with me at </span>
              <span className="link"> github.com/alderr.</span>
            </h3>
          </div>
        </section>
      </section>
