        ...
        <div className="mainQouteWrapper">
          <div className="mainQoute">
            ...
            <h1>
              ...
              <br />
              <span className="qoute secondWord"><span className="iLetter">I</span> get way too <span className="excited"> excited</span></span>
              ...
              <span className="qoute flaw-second"> I wouldn&apos;t change about myself.</span>
            </h1>
          </div>
        </div>
      </div>
